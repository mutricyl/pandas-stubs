...
class StringMethods(NoNewAttributesMixin, Generic[T, _TS]):
    ...
    def startswith(self, pat: str | tuple[str, ...], na: Any = ...) -> BoolSeries: ...
    def endswith(self, pat: str | tuple[str, ...], na: Any = ...) -> BoolSeries: ...
    ...
    def swapcase(self) -> T: ...
    def casefold(self) -> T: ...
    def isalnum(self) -> BoolSeries: ...
    def isalpha(self) -> BoolSeries: ...
    def isdigit(self) -> BoolSeries: ...
    def isspace(self) -> BoolSeries: ...
    def islower(self) -> BoolSeries: ...
    def isupper(self) -> BoolSeries: ...
    def istitle(self) -> BoolSeries: ...
    def isnumeric(self) -> BoolSeries: ...
    def isdecimal(self) -> BoolSeries: ...
    def fullmatch(
        self, pat: str, case: bool = ..., flags: int = ..., na: Any = ...
    ) -> BoolSeries: ...
